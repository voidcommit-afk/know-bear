...
import type { Mode, ExportRequest } from "../types";
...
export default function ExportDropdown({
  ...
  return (
    <div
      className={`relative ${compact ? "" : "w-full md:w-48"}`}
      ref={dropdownRef}
    >
      <button
      ...
      {isOpen && (
        <div
          className={`absolute z-50 w-56 md:w-full bottom-full md:bottom-auto md:top-full mb-2 md:mb-0 md:mt-2 right-0 bg-dark-800 border border-dark-600 rounded-xl shadow-2xl overflow-hidden animate-in fade-in slide-in-from-bottom-2 md:slide-in-from-top-2 duration-200`}
        >
